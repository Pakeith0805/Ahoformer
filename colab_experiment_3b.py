...
print(f"Starting Experiment 3B: 3-Layer High-Res (Sequence Length 258) + Mixup 0.8 (10-Fold CV)...")
...
for fold in range(K):
    ...
    # Configure embedding layer for high resolution (sequence length 258)
    ...
    best_weights_path = f"best_model_exp3b_fold_{fold}.pth"
...
print(f"\n==========================================")
print(f"Experiment 3B (3-Layer High-Res) CV Summary:")
...
}).to_csv("submission_exp3b.csv", index=False, header=False)
print("Saved predictions to submission_exp3b.csv")
