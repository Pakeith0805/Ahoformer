...
print(f"Starting Experiment 4B: 2-Channel Masked + Mixup 0.8 (5-Fold GroupKFold CV)...")
fold_val_rmses = []
predictions_all = []
...
for fold in range(K):
    ...
    best_weights_path = f"best_model_exp4b_fold_{fold}.pth"
...
print(f"\n==========================================")
print(f"Experiment 4B (2-Channel Masked GroupKFold) CV Summary:")
...
}).to_csv("submission_exp4b.csv", index=False, header=False)
print("Saved predictions to submission_exp4b.csv")
