...
print(f"Starting Experiment 6A: Full-Spectrum 2-Channel + Log Checkpoint + Augmentation (5-Fold GroupKFold CV)...")
fold_val_rmses = []
predictions_all = []
...
for fold in range(K):
    ...
    best_weights_path = f"best_model_exp6a_fold_{fold}.pth"
...
print(f"\n==========================================")
print(f"Experiment 6A CV Summary:")
...
}).to_csv("submission_exp6a.csv", index=False, header=False)
print("Saved predictions to submission_exp6a.csv")
