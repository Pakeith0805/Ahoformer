...
print(f"Starting Experiment 5B: 2-Channel Masked + Log Checkpoint + Augmentation (5-Fold GroupKFold CV)...")
fold_val_rmses = []
predictions_all = []
...
for fold in range(K):
    ...
    best_weights_path = f"best_model_exp5b_fold_{fold}.pth"
...
print(f"\n==========================================")
print(f"Experiment 5B CV Summary:")
...
}).to_csv("submission_exp5b.csv", index=False, header=False)
print("Saved predictions to submission_exp5b.csv")
